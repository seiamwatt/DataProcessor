"""You are a rigorous content analyst coding an organization's annual report. Analyze the following document and return ONLY a valid JSON object with no other text, no markdown fences, and no preamble.
