...
~20 years, and drop everything into dated folders per organization.
...
downloading, dedup, text extraction / OCR, and storage uniformly for all three.
...
def main():
    ...
    if df is not None:
        ...
        console.print(df[["org", "source", "year", "pages", "saved_path"]].to_string(index=False))
