...
from propublica_cloud_section import propublica_cloud_logic
import pandas_gbq
...
def show():
    ...
    while status:
        ...
        console.print("[bold red]Data will be appended to Google Big Query")
        input_valid = False
        ...
        if results:
            ...
            console.print("[bold green] Results appended to CLOUD [Big query]")
        else:
